...
class DigitalFilter:
    """
    Wide 3-20 Hz bandpass — covers the full HFOV physiological range.
    The adaptive narrow filter was removed because it prevented detection
    of frequencies across the full 5-15 Hz operating range.
    SNR quality is now handled by the SNR estimator using a peak-vs-noise
    method rather than relying on pre-filtering to improve the ratio.
    """
    ...
    def __init__(self, fs, bus, window=200, stride=20):
        ...
        # Wide bandpass covering full HFOV range
